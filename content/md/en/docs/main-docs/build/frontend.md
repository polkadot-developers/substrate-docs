...
Connecting via HTTP is commonly used for fetching data in off-chain workers-learn more about that in [Offchain operations](/fundamentals/offchain-operations).
