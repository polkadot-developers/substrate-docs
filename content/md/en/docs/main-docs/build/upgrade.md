...
The Substrate repository uses the [`D1-runtime-migration`](https://github.com/paritytech/substrate/pulls?q=is%3Apr+label%3AD1-runtime-migration) label to designate such changes.
