...
The Developer Hub snapshot of the [substrate-node-template](https://github.com/substrate-developer-hub/substrate-node-template/releases/tag/polkadot-v0.9.27) includes everything you need to get started with a core set of features.
...
1. Clone the node template repository using the `polkadot-v0.9.27` tag by running the following command:

   ```sh
   git clone --branch polkadot-v0.9.27 https://github.com/substrate-developer-hub/substrate-node-template
   ```
