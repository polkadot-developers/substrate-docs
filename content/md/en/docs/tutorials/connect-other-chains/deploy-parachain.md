...
It is still **_highly recommended_** to understand [the manual process](/tutorials/connect-other-chains/relay-chain/), as this script is not a perfect fit for all use cases.
...
1. Compile and have your relay chain node and parachain collator binaries ready.
   [Instructions here](/tutorials/connect-other-chains/relay-chain).
