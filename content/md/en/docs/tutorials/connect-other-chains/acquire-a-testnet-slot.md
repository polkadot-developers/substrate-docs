...
The steps are similar to the ones you followed in [Connect a local parachain](/tutorials/connect-other-chains/connect-a-local-parachain/) to reserve an identifier on the local relay chain.
...
In this tutorial, the relay chain is `rococo` instead of `rococo-local` used in the [Connect a local parachain](/tutorials/connect-other-chains/connect-a-local-parachain/) tutorial and the para identifier is `4105`.
