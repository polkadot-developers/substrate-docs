...
The `smoldot` light client doesn't author or import any blocks.
...
5. Install any remaining dependencies by running the following command:
...
10. Stop the `smoldot` light client node by pressing Control-c.
