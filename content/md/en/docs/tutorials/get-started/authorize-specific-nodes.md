...
For example, save the node key for Charlie to a file named `charlie-node-key`, note that any control character will make the hex decoder fail, you can use:

```bash
echo -n "3a9d5b35b9fb4c42aafadeca046f6bf56107bd2579687f069b42646684b94d9e" > charlie-node-key
```

Then run the following command to verify the peer identifier:
