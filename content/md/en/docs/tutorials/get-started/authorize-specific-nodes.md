...
1. Copy and paste the hex-encoded peer identifier for the node owned by Charlie(Do not forget to add prefix 0x). 
...
4. Copy and paste the hex-encoded peer identifier for the node owned by Charlie(Do not forget to add prefix 0x). 

5. For the connections parameter, copy and paste the hex-encoded peer identifier for the node owned by Dave(Do not forget to add prefix 0x), then click **Submit Transaction**.
...
3. Copy and paste the hex-encoded peer identifier for the node owned by Dave(Do not forget to add prefix 0x), then click **Submit Transaction**.
...
4. Copy and paste the hex-encoded peer identifier for the node owned by Dave(Do not forget to add prefix 0x). 

5. For the connections parameter, copy and paste the hex-encoded peer identifier for the node owned by Charlie(Do not forget to add prefix 0x), then click **Submit Transaction**.
