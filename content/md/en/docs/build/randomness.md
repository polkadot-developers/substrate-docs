...
However, applications that run on the blockchain are more tightly constrained. 
Pseudo-randomness introduces a security vulnerability for situations where being able to predict the outcome of a random function can lead to gaming the system.
