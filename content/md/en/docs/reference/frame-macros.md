...
- Read the [Rust documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/index.html#macros) on commonly used macros in FRAME.
...
- in `frame_support`:
  - [function-like](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/index.html#macros) macros
  - [derive](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/index.html#derives) macros
  - [attribute](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/index.html#attributes) macros

**Macros in the FRAME system library**

- in `sp_core`:
  - [function-like macros](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_core/index.html#macros) macros
  - [derive `RuntimeDebug`](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_core/index.html#derives) macro
- in `sp_runtime`:
  - [function-like](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_runtime/index.html#macros) macros
  - [derive](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_runtime/index.html#derives) macros
- in `serde`: [function-like](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_runtime/index.html#derives) macros
- in `sp_api`: [function-like](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_api/index.html#macros) macros
- in `sp_std`: [function-like](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_std/index.html#macros) macros
- in `sp_version`: [function-like](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_version/index.html#macros) macros
...
This is the [attribute macro](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html) that allows the pallet to be used in `construct_runtime!`. This macro
...
Provides constants that are part of the [`Config` trait](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_system/pallet/trait.Config.html) and gives information about external tools to use for the runtime.

**Docs**

- [Config trait](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#config-trait-palletconfig-mandatory)
...
- See use in the context of [#[pallet::config]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#config-trait-palletconfig-mandatory)
...
- See [documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#extra-constants-palletextra_constants-optional)
...
- See the [macro expansion](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#macro-expansion-1) added to the `struct Pallet<T>` definition
...
[`Hooks`](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/traits/trait.Hooks.html#provided-methods) are made available by using the `Hooks` trait.
...
- See the [documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#hooks-pallethooks-mandatory)
- See the [macro expansion](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#macro-expansion-2)
...
The `#[pallet::call]` aggregates all dispatchable function call logic using the [`Call` enum](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_system/pallet/enum.Call.html).
...
- See the [documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#call-palletcall-mandatory)
...
- See [documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#error-palleterror-optional)
...
- See [documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#event-palletevent-optional)
...
- See [macro documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#storage-palletstorage-optional)
- [`StorageMap` implementation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/pallet_prelude/struct.StorageMap.html#implementations)
...
- [#[pallet::genesis_config]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#genesis-config-palletgenesis_config-optional)
- [#[pallet::type_value]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#type-value-pallettype_value-optional)
- [#[pallet::genesis_build]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#genesis-build-palletgenesis_build-optional)
- [#[pallet::inherent]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#inherent-palletinherent-optional)
- [#[pallet::validate_unsigned]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#validate-unsigned-palletvalidate_unsigned-optional)
- [#[pallet::origin]](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#origin-palletorigin-optional)
...
- [API Documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/macro.construct_runtime.html)
...
- [API Documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/macro.parameter_types.html)
...
- [API Documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_api/macro.impl_runtime_apis.html)
...
- [API Documentation](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/sp_application_crypto/macro.app_crypto.html)
...
> As of January 2021, FRAME based pallets have upgraded their use of macros. Refer to [this guide](https://paritytech.github.io/substrate/master/h.github.io/substrate/master/frame_support/attr.pallet.html#upgrade-guidelines)
