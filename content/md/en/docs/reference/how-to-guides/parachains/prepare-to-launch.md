...
See the [Prepare a local relay chain](/tutorials/connect-parachains-to-a-network/prepare-a-local-relay-chain/) to for a selection of tools for automation of such testing.
