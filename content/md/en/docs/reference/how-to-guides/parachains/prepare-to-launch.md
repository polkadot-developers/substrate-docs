...
See the [Prepare a local relay chain](/tutorials/connect-other-chains/prepare-a-local-relay-chain/) to for a selection of tools for automation of such testing.
