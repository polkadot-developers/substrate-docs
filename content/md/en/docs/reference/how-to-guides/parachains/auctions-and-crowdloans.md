...
> Please first try everything out on the [Rococo Testnet](/tutorials/connect-parachains-to-a-network/acquire-a-testnet-slot/) before you attempt to go on a production network!
...
- Your parachain genesis state.
  Refer to the genesis state export process in the [Prepare a local relay chain](/tutorials/connect-parachains-to-a-network/prepare-a-local-relay-chain/).

- Your parachain Wasm runtime.
  Refer to the Wasm runtime export process in the [Prepare a local relay chain](/tutorials/connect-parachains-to-a-network/prepare-a-local-relay-chain/).
