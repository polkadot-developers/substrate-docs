...
1. Implement the `CreateSignedTransaction` trait in the runtime.
   ...
   You can see a full example of the code in the [**Substrate** code base](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/bin/node/runtime/src/lib.rs).
...
1. Implement `SigningTypes` and `SendTransactionTypes` in the runtime to support submitting transactions, whether they are signed or unsigned.
   ...
   You can see an example of this implementation in the [**Substrate** code base](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/bin/node/runtime/src/lib.rs#L1103-L1114).
...
1. Open the `src/lib.rs` file for your pallet in a text editor.
   ...
   To see a full example of how `ValidateUnsigned` is implemented in a pallet, refer to [`pallet-example-offchain-worker` in **Substrate**](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/frame/examples/offchain-worker/src/lib.rs#L301-L329).
...
1. Implement the `SendTransactionTypes` trait for the runtime as described in [sending signed transactions](#sending-signed-transactions).
   ...
   You can see a full example in [`pallet-example-offchain-worker` in **Substrate** code base](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/frame/examples/offchain-worker).
...
1. To make your data structure signable, implement the [`SignedPayload` trait](https://paritytech.github.io/substrate/master/frame_system/offchain/trait.SignedPayload.html).
   ...
   You can also see an example [here](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/frame/examples/offchain-worker/src/lib.rs#L348-L361).
...
Refer to the [offchain function call](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/frame/examples/offchain-worker/src/lib.rs#L508-L536) and [the implementation of `ValidateUnsigned`](https://github.com/paritytech/substrate/blob/polkadot-v0.9.27/frame/examples/offchain-worker/src/lib.rs#L305-L329) for a working example of the above.
...
- [Substrate Offchain Worker Example Pallet](https://github.com/paritytech/substrate/tree/polkadot-v0.9.27/frame/examples/offchain-worker)
