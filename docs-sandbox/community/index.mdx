---
title: Welcome to the Substrate developer community
slug: /community/
version: '3.0'
section: community
...
You can download a copy of the Markdown template directly from [here](https://github.com/substrate-developer-hub/substrate-docs/tree/main/static/contribute-templates/how-to-template.md/"target="_blank).

After downloading the template, rename the file and replace the description of each section with the relevant content.
The following template outline provides suggestions for the content to put in each section of the how-to guide.
...
You can specify the content category for your article by adding one of the following tags:
