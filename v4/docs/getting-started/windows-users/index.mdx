...
slug: /v4/docs/knowledgebase/getting-started/windows-users
---
...
8. Install `make`
    - This can be done using Chocolatey. First you need to install 
    the Chocolatey package manager: https://chocolatey.org/install
