...
> Please first try everything out on the [Rococo Testnet](/how-to-guides/v3/parachains/rococo) before you attempt to go on a production network!
...
This guarantees the now parachain will always have their block data hashed and included in the relay chain block (called Proof of Validation, or short for **PoV**), during the slot duration they are allotted.
