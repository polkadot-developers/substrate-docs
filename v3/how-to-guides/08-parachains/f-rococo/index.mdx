...
Once you've gone through the above steps and are ready to connect, **open a request for a slot by filling out the [Rococo Slot Request Form](https://github.com/paritytech/subport/issues/new?assignees=&labels=Rococo&template=rococo.yaml).**
