...
1. **Complete the [Cumulus Tutorial](/tutorials/v3/cumulus/) and fully test your parachain on your local machine!**
...
1. You will need 5 ROCs from the [Rococo faucet](https://matrix.to/#/#rococo-faucet:matrix.org) to register a para ID.
   Use the `!drip <accountID>` command in that channel to get 100 ROC before you continue.

3. You ***must*** have you collator's peering ports for the embedded relay chain and your parachain publicly accessible and discoverable.
