...
<Objectives
  data={[
    {
      title: 'Goal',
      description: 'Learn how to write tests and improve the correctness of a `transfer` function.',
    },
    {
      title: 'Use Cases',
    ...
    {
      title: 'Overview',
      description: `Testing each function is an imporant part of developing pallets for production. This guide
