...
<Objectives
  data={[
    {
      title: 'Title',
      description: 'The guide\'s intentions should be clear by just reading the title.',
    },
    {
      title: 'Goal',
      description:
...
text={ [
    ...
    <a href="https://github.com/substrate-developer-hub/substrate-how-to-guides/blob/main/docs/contribute/how-to-template.md"> here </a>,
