...
1. In the pallet you want to use, import the [`Randomness`](/rustdocs/latest/frame_support/traits/trait.Randomness.html)
...
1. Update your pallet's runtime implementation.
    ...
    This is accomplished by using the [Randomness Collective Flip pallet][rcf-pallet-rustdocs].
