...
<Objectives
  data={[
    ...
    },
    {
      title: 'Overview',
      description:
        `[Randomness](/v3/docs/runtime/randomness)is useful in computer programs for everything from gaming applications to selecting block
...
<Message
  ...
  text={[
    'Learn more about ',
    <ExternalLink
      url={`/rustdocs/latest/funty/trait.IsInteger.html#tymethod.wrapping_add`}
    >
      wrapping_add
    </ExternalLink>,
    ' and ',
    <ExternalLink
      url={`/rustdocs/latest/frame_support/dispatch/trait.Encode.html#method.encode`}
    >
      encode()
    </ExternalLink>,
