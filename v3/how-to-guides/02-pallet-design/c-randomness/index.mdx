...
1. Create a nonce.
  ...
  * **Create a private nonce function.** This will be used to increment the nonce each time it's used.
  ...
  To learn more about the wrapping and encoding methoeds, see [\`wrapping_add\`](/rustdocs/latest/funty/trait.IsInteger.html#tymethod.wrapping_add) and [\`encode()\`](/rustdocs/latest/frame_support/dispatch/trait.Encode.html#method.encode) in the Rust documentation.
  `}/>
