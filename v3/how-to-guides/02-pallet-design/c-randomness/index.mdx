...
1. Create a nonce.
  ...
  the nonce. For example:
    ...
    ```
   To learn more about the wrapping and encoding methods, see [`wrapping_add`](/rustdocs/latest/funty/trait.IsInteger.html#tymethod.wrapping_add) and [`encode()`](/rustdocs/latest/frame_support/dispatch/trait.Encode.html#method.encode) in the Rust documentation.
