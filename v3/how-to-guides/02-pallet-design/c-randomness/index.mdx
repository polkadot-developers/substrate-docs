...
slug: /v3/how-to-guides/pallet-design/randomness
...
<Message
  ...
  text={[
      'As stated in',
      <a href="https://substrate.dev/rustdocs/v3.0.0/frame_support/traits/trait.Randomness.html"> this trait's documentation</a>,
...
<Message
  ...
  text={[
      'Learn more about ',
      <ExternalLink url={`https://substrate.dev/rustdocs/v3.0.0/funty/trait.IsInteger.html#tymethod.wrapping_add`}>wrapping_add</ExternalLink>,
      ' and ', 
      <ExternalLink url={`https://substrate.dev/rustdocs/v3.0.0/frame_support/dispatch/trait.Encode.html#method.encode`}>encode()</ExternalLink>, 
...
## Related material
#### Other
- <ExternalLink url={`https://en.wikipedia.org/wiki/Verifiable_random_function`}>Verifiable Random Functions</ExternalLink>
