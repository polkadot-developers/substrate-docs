...
- Conviction voting`,
    ...
    {
      title: 'Overview',
      description: `The [\`LockableCurrency\`](/rustdocs/latest/frame_support/traits/trait.LockableCurrency.html) trait can be very useful in the context of economic systems that enforce accountability by collateralizing fungible resources.
