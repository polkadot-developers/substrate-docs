...
This guide shows you how to create a [\`StorageValue\`](/rustdocs/latest/frame_support/storage/trait.StorageValue.html) struct and use it in \`on_initialize\`. This struct does the following:
