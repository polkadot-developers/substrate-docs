...
- On-chain execution of Wasm binaries`,
    },
    {
      title: 'Overview',
      description:
        `This guide will show you how you can add the [Contracts pallet](/rustdocs/latest/pallet_contracts/index.html) to your runtime in order to allow your blockchain
