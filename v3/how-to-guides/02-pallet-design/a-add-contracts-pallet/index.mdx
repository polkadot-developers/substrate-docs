...
<Objectives
  data={[
    ...
    {
      title: 'Use Cases',
      description: `- Developping a chain capable of handling smart contracts
- On-chain execution of Wasm binaries`,
    },
    {
      title: 'Overview',
      description: `This guide will show you how you can add the [Contracts pallet](/rustdocs/latest/pallet_contracts/) to your runtime in order to allow your blockchain
