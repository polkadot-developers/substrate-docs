...
<Message
  ...
  text=
    ...
    [this tutorial](/v3/tutorials/create-your-first-substrate-chain/).
    "
/>
...
Start by making sure you've included all of the types that `pallet_contracts` exposes. You can copy these from [FRAME's source code][contracts-frame]
...
<Message
  ...
  title={`Tip`}
  text={[
    'Unsure what version to import? Use the latest version as ',
    'indicated in ',
    <ExternalLink url={`https://crates.io/search?q=pallet-contracts-rpc`}>
      crates.io
    </ExternalLink>,
    '.',
  ]}
...
[contracts-frame]: /rustdocs/latest/pallet_contracts/
[create-first-chain-tutorial]: /v3/tutorials/create-your-first-substrate-chain
