...
<Message
  ...
  <a href="../../tutorials/create-your-first-substrate-chain/">this tutorial</a>,
  '.']}
/>
...
<Message
  type={`green`}
  title={`Tip`}
  text={['Unsure what version to import? Use the latest version as ', 
  'indicated in ', 
  <ExternalLink url={`https://crates.io/search?q=pallet-contracts-rpc`}>crates.io</ExternalLink>,
  '.'
  ]}
/>
