  ...
  data={[
    {
      title: 'Goal',
      description:
        'Provide a GRANDPA and PoW consensus engine to a service client.',
    },
    {
      title: 'Use Cases',
...
[GrandpaAPI](https://paritytech.github.io/substrate/master/sp_finality_grandpa/trait.GrandpaApi.html). Read about Substrate's
...
[GrandpaAPI](https://paritytech.github.io/substrate/master/sp_finality_grandpa/trait.GrandpaApi.html), so you'll need a runtime
...
[`import_queue` helper function](https://paritytech.github.io/substrate/master/sc_consensus_pow/fn.import_queue.html).
...
[`Config`](https://paritytech.github.io/substrate/master/sc_finality_grandpa/struct.Config.html):
...
[`GrandpaParams`](https://paritytech.github.io/substrate/master/sc_finality_grandpa/struct.GrandpaParams.html).
...
[inherents-rustdocs]: https://paritytech.github.io/substrate/master/sp_inherents/trait.InherentDataProvider.html
