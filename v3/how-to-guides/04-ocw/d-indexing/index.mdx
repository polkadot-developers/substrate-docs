...
1. Define the indexing data and save it using off-chain indexing:
   ...
   In the above code, data is stored via off-chain indexing using the [`offchain_index::set()`](https://paritytech.github.io/substrate/master/sp_io/offchain_index/fn.set.html) method.
