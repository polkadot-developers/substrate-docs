...
The concept of a **Storage Lock** is introduced to have value accessible consistently among mutliple OCWs.
...
- [**Off-chain worker example pallet** in Substrate](https://github.com/paritytech/substrate/blob/monthly-2021-12/frame/examples/offchain-worker/src/lib.rs#L374-L437)
