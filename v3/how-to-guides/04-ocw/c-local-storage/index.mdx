...
- [**Off-chain worker example pallet** in Substrate](https://github.com/paritytech/substrate/blob/polkadot-v0.9.22/frame/examples/offchain-worker/src/lib.rs#L372-L441)
