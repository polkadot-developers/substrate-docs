...
- [**Offchain Worker Example Pallet** in Substrate](https://github.com/paritytech/substrate/blob/polkadot-v0.9.20/frame/examples/offchain-worker/src/lib.rs#L571-L625)
