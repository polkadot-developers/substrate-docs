...
Refer to the [off-chain function call](https://github.com/paritytech/substrate/blob/polkadot-v0.9.23/frame/examples/offchain-worker/src/lib.rs#L508-L536) and [the implementation of `ValidateUnsigned`](https://github.com/paritytech/substrate/blob/polkadot-v0.9.23/frame/examples/offchain-worker/src/lib.rs#L305-L329) for a working example of the above.
...
- [Substrate Offchain Worker Example Pallet](https://github.com/paritytech/substrate/tree/polkadot-v0.9.23/frame/examples/offchain-worker)
