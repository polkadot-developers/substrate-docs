...
1. Save the Wasm blob of a previous state.
    ...
    ```bash
    subwasm get --chain polkadot --block 0xfdeab19649426aadbdab046c9b5dac0a5b0c850b8fd0927e3b4e6c896d5fb0b7 -o polkadot-50000.wasm
    ```
...
1. Compare the two runtimes.

    ```bash
    subwasm diff polkadot-latest.wasm polkadot-50000.wasm
    ```
