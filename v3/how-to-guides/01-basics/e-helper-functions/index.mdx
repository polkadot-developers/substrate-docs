...
slug: /v3/how-to-guides/basics/helper-functions
...
- <ExternalLink url={`https://docs.rs/num/0.2.0/num/trait.CheckedAdd.html#required-methods`}> checked_add </ExternalLink>
- <ExternalLink url={`https://doc.rust-lang.org/std/option/enum.Option.html#method.ok_or`}> ok_or </ExternalLink>