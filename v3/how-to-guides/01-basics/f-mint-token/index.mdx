...
<Message
  ...
  title={`Information`}
  text=
    "This is a beginner guide intended for novice
    Substrate developers looking to explore ways to create tokens in Substrate.
    This approach _is not_ recommended best practice.
...
[storagemap-rustdocs]: /rustdocs/latest/frame_support/storage/trait.StorageMap.html
