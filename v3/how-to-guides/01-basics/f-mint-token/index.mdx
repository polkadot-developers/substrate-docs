...
<Message
  ...
  title={`Information`}
  text={[
  'This is a beginner recipe intended for novice', 
  'Substrate developers looking to explore ways to create tokens in Substrate.', 
  'This approach is not recommended best practice.',
...
<Message
  ...
  text={[
  'The `mint` function takes in an amount to mint which is *not good practice* because it implies that',
  ...
  <a href="https://substrate.dev/docs/en/knowledgebase/runtime/origin"> here. </a>,
  ]} 
  />
