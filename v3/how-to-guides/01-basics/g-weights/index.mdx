...
<Message
  ...
  <a href="../weights/calculate-fees">on weights</a>,
  '.'
  ]}
/>
...
#### Other
- <ExternalLink url={`https://wiki.polkadot.network/docs/en/learn-transaction-fees`}>Polkadot's Transaction Fees </ExternalLink>
