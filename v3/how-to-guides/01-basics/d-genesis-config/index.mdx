...
Genesis configuration is a tool for testing chain behavior by defining an initial state for things such as accounts, balances, genesis for custom pallets, and more. 
