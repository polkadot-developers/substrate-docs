...
```rust
[dependencies]
frame-try-runtime = { git = "https://github.com/paritytech/substrate.git", default-features = false, branch = "polkadot-v0.9.20", optional = true }
try-runtime-cli = { git = "https://github.com/paritytech/substrate.git", branch = "polkadot-v0.9.20", optional = true }
...
try-runtime = [
  ...
  # add "pallet/try-runtime",
]
```

#### In `pallets/pallet_name/Cargo.toml`, for every pallet from your runtime:
