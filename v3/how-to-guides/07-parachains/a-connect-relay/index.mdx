...
<Objectives
  ...
  - Obtain a parachain slot
    ...
    },
    {
      title: 'Overview',
      description: `
  Launching a parachain requires a series of steps to ensure that the relay chain knows exactly what is the parachain runtime logic once this parachain gets a slot on the relay chain.
