...
category: parachains
difficulty: 3
keywords: [collators, parachains, runtime upgrade, cumulus, storage migration]
---
    ...
    },
    {
      ...
      description: `
        ...
        **quickly and succinctly** enough for the block inclusion in the relay chain.
		\n
		**Before you continue**, please read the generic 
		[runtime upgrade docs](/v3/runtime/upgrades) and complete the
