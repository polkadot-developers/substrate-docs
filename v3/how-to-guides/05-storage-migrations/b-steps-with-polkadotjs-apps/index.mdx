...
This simple guide presents the steps for triggering a runtime migration using <ExternalLink url={`https://polkadot.js.org/apps/`}>Polkadot-JS apps</ExternalLink>. 
...
- <ExternalLink url={`https://polkadot.js.org/docs/`}>Polkadot JS documentation</ExternalLink>
- <ExternalLink url={`https://polkadot.js.org/apps/`}>Polkadot-JS Apps</ExternalLink>
