...
[the `decl_storage` macro](/v3/runtime/storage#declaring-storage-items)) when determining the hashed
...
- Learn how to add [storage items](/v3/runtime/storage) into your Substrate runtime modules.
