...
[`state_db` layer](https://substrate.dev/rustdocs/latest/sc_state_db) that maintains the
...
example, the [Sudo](https://substrate.dev/rustdocs/latest/pallet_sudo) pallet exposes a
...
Substrate's [FRAME Support crate](https://substrate.dev/rustdocs/latest/frame_support)
