---
title: Consensus
slug: /v3/docs/advanced/consensus
version: 3.0 
section: docs
category: advanced
keywords:
...
[state transition function](/v3/docs/concepts/runtime) must be deterministic.
...
[extrinsics](/v3/docs/concepts/extrinsics). The header must contain a reference to its parent block
