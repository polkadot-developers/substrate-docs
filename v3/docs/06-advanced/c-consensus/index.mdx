---
title: Consensus
slug: /docs/v3/advanced/consensus
version: 3.0 
section: docs
category: advanced
keywords:
...
[state transition function](/docs/v3/concepts/runtime) must be deterministic.
...
[extrinsics](/docs/v3/concepts/extrinsics). The header must contain a reference to its parent block
