...
[`#[pallet::event]`](../../runtime/macros#palletevents),
[`#[pallet::error]`](../../runtime/macros#palleterror),
[`#[pallet::storage]`](../../runtime/macros#palletstorage),
[`#[frame_support::pallet]`](../../runtime/macros#frame_supportpallet)
and compose pallets (e.g. [`construct_runtime!`](../../runtime/macros#construct_runtime)
...
the macros mentioned above are all defined in the [`frame_support`](../../runtime/frame#support-library)
