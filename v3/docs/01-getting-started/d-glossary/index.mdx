...
[well-known development accounts](/v3/toolchains/subkey#well-known-keys) (Alice, Bob, Charlie, Dave,
Ferdie, and Eve) are generated from the same dev phrase. The dev phrase is:
`bottom drive obey lake curtain smoke basket hold race lonely fit walk`.

Many tools in the Substrate ecosystem, such as [`subkey`](/v3/toolchains/subkey), allow users to
...
developers to define custom pallets (e.g. [`#[pallet::event]`](../../runtime/macros#palletevents),
[`#[pallet::error]!`](../../runtime/macros#palleterror), [`#[pallet::storage`](../../runtime/macros#palletstorage),
[`#[frame_support::pallet`](../../runtime/macros#frame_supportpallet) and compose pallets (e.g.
...
[chain specification](/v3/toolchains/chain-specs) file, which makes it easy to use a
