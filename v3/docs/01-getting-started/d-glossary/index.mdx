---
title: Glossary
slug: /v3/docs/getting-started/glossary
version: 3.0 
section: docs
...
[well-known development accounts](/v3/docs/toolchains/subkey#well-known-keys) (Alice, Bob, Charlie, Dave,
Ferdie, and Eve) are generated from the same dev phrase. The dev phrase is:
`bottom drive obey lake curtain smoke basket hold race lonely fit walk`.

Many tools in the Substrate ecosystem, such as [`subkey`](/v3/docs/toolchains/subkey), allow users to
...
Within the [Balances pallet](/v3/docs/runtime/frame#balances), this is the minimum
...
[chain specification](/v3/docs/toolchains/chain-specs) file, which makes it easy to use a
...
expose [lots of helpful metadata](/v3/docs/runtime/metadata).
...
[three built-in origins](/v3/docs/runtime/origins#raw-origins); [pallet](#pallet)
...
[a simple key/value map](/v3/docs/advanced/storage) where both keys and values can be
...
[runtime storage](/v3/docs/runtime/storage).
...
[signatures](/v3/docs/concepts/extrinsics#signed-transactions) or
[signed extensions](/v3/docs/concepts/extrinsics#signed-extension).
