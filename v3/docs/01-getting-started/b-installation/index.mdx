...
in the Substrate [Tutorials](/v3/tutorials) and [Recipes](https://substrate.dev/recipes)
...
development is to follow the steps in [our first tutorial](/v3/tutorials/create-your-first-substrate-chain).
