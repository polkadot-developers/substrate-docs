---
title: Installation
slug: /v3/docs/getting-started/installation
---
...
<Message
  ...
  text={[
    ...
    <a href="https://github.com/substrate-developer-hub/substrate-node-template/tree/v3.0.0%2Bmonthly-2021-05">
      node template `monthly-2021-05`
    </a>,
    'that you should use as a base for building on M1s. If you decide not to use a monthly release, see ',
    <a href="https://github.com/substrate-developer-hub/substrate-node-template/issues/179#issuecomment-843522331">
      this community contributed script (and discussion)`
    </a>,
