...
slug: /v3/docs/smart-contracts/contracts-pallet
version: 3.0 
section: docs
...
<AccentButton text={`Start the ink! workshop`} link={`/v3/tutorials/substrate-contracts-workshop`} />
-->
...
[**weight system**](/v3/docs/concepts/weight) and a single unit of gas. Thus, to execute a transaction, a user must have a free balance
...
- Follow [this
  how-to guide](/v3/how-to-guides/pallet-design/contracts-pallet) to learn how to add the Contracts pallet to your Substrate runtime.
