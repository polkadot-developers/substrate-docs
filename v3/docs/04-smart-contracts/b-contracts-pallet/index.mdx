...
The [Contracts pallet](https://substrate.dev/rustdocs/latest/pallet_contracts) provides
...
👉 &nbsp; [Start the ink! workshop](/tutorials/substrate-contracts-workshop)
...
[**weight system**](../getting-started/weight) and a single unit of gas. Thus, to execute a transaction, a user must have a free balance
...
- Visit the reference docs for the
  [Contracts pallet](https://substrate.dev/rustdocs/latest/pallet_contracts).
