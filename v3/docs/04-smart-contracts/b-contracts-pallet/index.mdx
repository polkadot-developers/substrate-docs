...
slug: /docs/v3/smart-contracts/contracts-pallet
version: 3.0 
section: docs
...
The [Contracts pallet](/rustdocs/latest/pallet_contracts) provides
...
<!-- Commenting out as the tut doesn't exist for now
<AccentButton text={`Start the ink! workshop`} link={`/tutorials/v3/substrate-contracts-workshop`} />
-->
...
[**weight system**](/docs/v3/concepts/weight) and a single unit of gas. Thus, to execute a transaction, a user must have a free balance
...
- Follow [this how-to guide](/how-to-guides/v3/pallet-design/contracts-pallet) to learn how to add
the Contracts pallet to your Substrate runtime.

### References

- Visit the reference docs for the
  [Contracts pallet](/rustdocs/latest/pallet_contracts).
