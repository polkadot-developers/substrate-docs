...
slug: /v3/smart-contracts/contracts-pallet
version: 3.0 
section: docs
...
[**weight system**](/v3/concepts/weight) and a single unit of gas. Thus, to execute a transaction, a user must have a free balance
