---
title: EVM Pallet
slug: /v3/docs/smart-contracts/evm-pallet
version: 3.0 
section: docs
...
together with the [Ethereum pallet](https://docs.rs/pallet-ethereum) and the
...
<!-- Commenting as frontier-workshop doesn't exist for now
<AccentButton text={`Start the Frontier workshop`} link={`/v3/tutorials/frontier-workshop`} />
-->
...
- Learn about our [Contracts pallet](/rustdocs/latest/pallet_contracts), which supports deployment
  and execution of Wasm smart contracts.

### Examples

- Follow a [tutorial to add a pallet to your FRAME runtime](/v3/tutorials/add-a-pallet/).
