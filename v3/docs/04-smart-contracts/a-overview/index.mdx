---
title: Overview
slug: /v3/docs/smart-contracts/overview
version: 3.0 
section: docs
...
The [**FRAME Contracts pallet**](/rustdocs/latest/pallet_contracts/index.html)
...
- Follow a
  [this guide](../../../v3/how-to-guides/pallet-design/contracts-pallet) to learn how to add the Contracts pallet to your FRAME runtime.
- Learn how to
