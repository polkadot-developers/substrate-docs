...
slug: /v3/docs/concepts/account-abstractions
version: 3.0 
section: docs
category: concepts
keywords:
...
<Message
  ...
  in the context of the Substrate's NPoS [Staking pallet](/rustdocs/latest/pallet_staking).`}
/>
...
[Balances pallet](/rustdocs/latest/pallet_balances), these accounts
...
- Learn more about Session Keys in the [this article](../session-keys).
