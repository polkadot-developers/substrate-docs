...
<Message
  ...
  in the context of the Substrate's NPoS [Staking pallet](https://paritytech.github.io/substrate/master/pallet_staking/index.html).`}
/>
...
[Balances pallet](https://paritytech.github.io/substrate/master/pallet_balances/index.html), these accounts
...
- Visit the reference docs for the
  [session keys runtime API](https://paritytech.github.io/substrate/master/sp_session/trait.SessionKeys.html).

- Take a look at the default
  [session keys in the Substrate node runtime](https://paritytech.github.io/substrate/master/node_runtime/struct.SessionKeys.html).
