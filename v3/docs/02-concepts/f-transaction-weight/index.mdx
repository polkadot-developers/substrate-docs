...
[Transaction Fees document](../../runtime/weights-and-fees).

Substrate defines one unit of weight as one picosecond of execution time, that is **10 12
...
[Transaction Fees](../../runtime/weights-and-fees) to learn more about the different dispatch classes and
when to use them.
