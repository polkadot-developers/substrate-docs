...
Substrate provides the [Session pallet](/v3/runtime/frame#session), which allows validators to manage 
their session keys.
...
[Session pallet](/rustdocs/latest/pallet_session/trait.Config.html#associatedtype.Keys).
