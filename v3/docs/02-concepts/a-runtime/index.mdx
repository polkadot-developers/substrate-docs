...
[`Metadata`](/rustdocs/latest/sp_api/trait.Metadata.html) runtime APIs. In addtion to these, a basic Substrate Node
...
[pallets](/v3/runtime/pallets). Each pallet encapsulates domain-specific logic that is expressed as a set of a
[storage items](/v3/runtime/storage), [events](/v3/runtime/events),
[errors](/v3/runtime/errors) and
...
including [over 50 that ship with Substrate](/v3/runtime/frame#prebuilt-pallets).
