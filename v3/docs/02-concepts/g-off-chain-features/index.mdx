...
slug: /v3/docs/concepts/off-chain-features
version: 3.0 
section: docs
category: concepts
keywords:
...
- [Submit signed and unsigned transactions from off-chain workers back on-chain](https://substrate.dev/recipes/off-chain-workers/transactions.html)
- [Fetch external data using HTTP requests and parse JSON responses](https://substrate.dev/recipes/off-chain-workers/http-json.html)
- [Store result in off-chain worker local storage](https://substrate.dev/recipes/off-chain-workers/storage.html)
- [Example of off-chain indexing](https://substrate.dev/recipes/off-chain-workers/indexing.html)
