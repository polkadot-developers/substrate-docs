...
[`Key`](https://paritytech.github.io/substrate/master/pallet_sudo/pallet/struct.Pallet.html#method.key):
...
- Visit the reference docs for
  [`paritytech/trie`](https://paritytech.github.io/substrate/master/trie_db/trait.Trie.html).
