...
In all cases for Substrate, the [Blake2b-512](https://datatracker.ietf.org/doc/html/rfc7693) ([Wiki](<https://en.wikipedia.org/wiki/BLAKE_(hash_function)>)) hash function is used (OID 1.3.6.1.4.1.1722.12.2.1.16).
