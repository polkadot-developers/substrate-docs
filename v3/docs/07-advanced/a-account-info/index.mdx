...
[`frame-system` pallet](https://paritytech.github.io/substrate/master/frame_system/index.html),
extracted below.

[`frame/system/src/lib.rs`](https://paritytech.github.io/substrate/master/src/frame_system/lib.rs.html#530):
...
[`StorageMap` API doc](https://paritytech.github.io/substrate/master/frame_support/storage/types/struct.StorageMap.html#impl)
for details.
...
[`frame/system/src/lib.rs`](https://paritytech.github.io/substrate/master/src/frame_system/lib.rs.html#788-803):
...
Refer to [`frame-system` API doc](https://paritytech.github.io/substrate/master/frame_system/pallet/struct.Pallet.html#impl-11)
for details.

## `AccountData` trait and implementation

Back to the `AccountInfo` struct. The last piece of data in `AccountInfo` is `AccountData`. It can be any struct as long as it satisfies the associated type `AccountData` trait bound defined in [`frame-system::pallet::Config` trait](https://paritytech.github.io/substrate/master/frame_system/pallet/trait.Config.html#associatedtype.AccountData). Out of the box Substrate runtime configures it to be [`AccountData` struct](https://paritytech.github.io/substrate/master/pallet_balances/struct.AccountData.html) defined in `pallet-balances` as shown below.

[`frame/balances/src/lib.rs`](https://paritytech.github.io/substrate/master/src/pallet_balances/lib.rs.html#566-586)
...
looking into the [`frame_system::AccountInfo` API doc](https://paritytech.github.io/substrate/master/frame_system/struct.AccountInfo.html)
and [`pallet_balances::AccountData` API doc](https://paritytech.github.io/substrate/master/pallet_balances/struct.AccountData.html).
