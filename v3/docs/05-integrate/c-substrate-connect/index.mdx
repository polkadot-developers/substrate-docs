...
The `@substrate/connect` library has the following capabilities:
...
If developers want to generate a light client of their chain, all it takes is just one command to 
compile a library that contains everything needed to run one in the browser.

Refer to these resources to get started with Substrate Connect:

- [Project page](https://paritytech.github.io/substrate-connect/)
- [API documentation](https://paritytech.github.io/substrate-connect/api/)
