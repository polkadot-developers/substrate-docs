...
specific light clients for Substrate chains. It uses light clients that are part of the 
...
managing mutliple connected blockchains where all light clients are running in a single browser tab. 
...
means that all you need is the [chainspec](/v3/runtime/chain-specs) of a Substrate based chain to connect
