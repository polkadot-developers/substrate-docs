...
The [FRAME System crate `frame_system`](/rustdocs/latest/frame_system) provides low-level types,
...
The [FRAME Support Crate `frame_support`](/rustdocs/latest/frame_support) is a collection of Rust
...
The [FRAME Executive Pallet `frame_executive`](/rustdocs/latest/frame_executive) acts as the
