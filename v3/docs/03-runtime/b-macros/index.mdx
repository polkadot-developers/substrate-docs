...
Provides constants that are part of the [`Config` trait](/rustdocs/latest/frame_system/pallet/trait.Config.html) to specify how a pallet is configured for the runtime, allowing developers to tweak the pallet's behaviour.
