...
> - read the [documentation](https://substrate.dev/rustdocs/latest/frame_support#macros) on commonly used macros in FRAME
...
- in `frame_support`: 
  - [function-like](https://substrate.dev/rustdocs/latest/frame_support#macros) macros
  - [derive](https://substrate.dev/rustdocs/latest/frame_support#derives) macros
  - [attribute](https://substrate.dev/rustdocs/latest/frame_support#attributes) macros


**Macros in the Substrate [System Library](./frame#system-library):**
- in `sp_core`: 
  - [function-like macros](https://substrate.dev/rustdocs/latest/sp_core#macros) macros
  - [derive `RuntimeDebug`](https://substrate.dev/rustdocs/latest/sp_core#derives) macro
- in `sp_runtime`: 
  - [function-like](https://substrate.dev/rustdocs/latest/sp_runtime#macros) macros
  - [derive](https://substrate.dev/rustdocs/latest/sp_runtime#derives) macros
- in `serde`: [function-like](https://substrate.dev/rustdocs/latest/sp_runtime#derives) macros
- in `sp_api`: [function-like](https://substrate.dev/rustdocs/latest/sp_api#macros) macros
- in `sp_std`: [function-like](https://substrate.dev/rustdocs/latest/sp_std#macros) macros
- in `sp_version`: [function-like](https://substrate.dev/rustdocs/latest/sp_version#macros) macros
