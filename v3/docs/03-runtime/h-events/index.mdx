...
Substrate provides a default implementation of how to deposit an event using macros, which varies slightly depending on [FRAME version adopted](runtime/macros#overview-of-frame-versioning). In FRAME v1:
