...
like the [Polkadot-JS API](/v3/toolchains/polkadot-js), however you can implement your own
...
System module. Otherwise, the [Polkadot-JS API](/v3/toolchains/polkadot-js) supports a WebSocket
...
- Learn more about using the [Polkadot-JS API](/v3/toolchains/polkadot-js).
