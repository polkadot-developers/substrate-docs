...
FRAME also provides some helper modules to interact with important [Substrate Primitives](https://substrate.dev/rustdocs/latest/sc_service) that provide the
...
The [System library](https://substrate.dev/rustdocs/latest/frame_system) provides
...
The [FRAME Executive module](https://substrate.dev/rustdocs/latest/frame_executive) acts as the
orchestration layer for the runtime. It dispatches incoming extrinsic calls to the respective
pallets in the runtime.

### Support Library

The [FRAME Support library](https://substrate.dev/rustdocs/latest/frame_support) is a
...
- [Docs](https://substrate.dev/rustdocs/latest/frame_benchmarking)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_assets)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_atomic_swap)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_aura)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_authority_discovery)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_authorship)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_babe)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_balances)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_collective)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_contracts)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_democracy)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_elections_phragmen)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_elections)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_example_offchain_worker)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_example)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_grandpa)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_identity)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_im_online)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_indices)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_membership)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_multisig)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_nicks)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_offences)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_proxy)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_randomness_collective_flip)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_recovery)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_scheduler)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_scored_pool)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_session)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_society)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_staking)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_sudo)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_timestamp)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_transaction_payment)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_treasury)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_utility)
...
- [Docs](https://substrate.dev/rustdocs/latest/pallet_vesting)
...
- Visit the reference docs for the
  [System library](https://substrate.dev/rustdocs/latest/frame_system).

- Visit the reference docs for the
  [Executive pallet](https://substrate.dev/rustdocs/latest/frame_executive).

- Visit the reference docs for the
  [FRAME support library](https://substrate.dev/rustdocs/latest/frame_support).
