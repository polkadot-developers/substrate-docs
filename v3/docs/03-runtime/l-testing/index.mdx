...
The [`sp-io`](https://substrate.dev/rustdocs/latest/sp_io) crate exposes a
...
[`substrate_state_machine`](https://substrate.dev/rustdocs/latest/sp_state_machine)]
referred to as
...
[Externalities](https://substrate.dev/rustdocs/latest/sp_externalities) allow developers
to construct runtime environments that provide access to features of the outer node. Another example
of this can be found in
[`offchain`](https://substrate.dev/rustdocs/latest/sp_core/offchain), which maintains its
