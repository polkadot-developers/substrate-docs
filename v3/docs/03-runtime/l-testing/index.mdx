...
The [`sp-io`](/rustdocs/latest/sp_io) crate exposes a
...
[`substrate_state_machine`](/rustdocs/latest/sp_state_machine)]
referred to as
...
[`with_externalities`](/rustdocs/latest/sp_externalities/fn.with_externalities.html)
...
[Externalities](/rustdocs/latest/sp_externalities) allow developers
to construct runtime environments that provide access to features of the outer node. Another example
of this can be found in
[`offchain`](/rustdocs/latest/sp_core/offchain), which maintains its
own [Externalities](/rustdocs/latest/sp_core/offchain/trait.Externalities.html)
implementation.
