...
The [FRAME benchmarking module](https://paritytech.github.io/substrate/master/frame_benchmarking/benchmarking/index.html) has a set
...
documentation](https://paritytech.github.io/substrate/master/frame_benchmarking/macro.benchmarks.html).
