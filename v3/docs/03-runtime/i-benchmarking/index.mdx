...
This framework uses Rust macros to help users easily integrate them into their runtime.
...
3. Then, in addition to your normal runtime configuration, you also need to update the benchmarking
   ...
   Assuming you use any of our starting templates, this code should already exist within your runtime. 
   There seems to be a lot of code, but we are mainly just setting up the environment
...
- `execution` and `wasm-execution` specify we are benchmarking the compiled Wasm code (versus the native
