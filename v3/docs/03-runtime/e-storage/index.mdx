...
Runtime storage items are created in the [`decl_storage` macro](/rustdocs/latest/frame_support/macro.decl_storage.html) in any FRAME-like pallet. Here is an example of declaring the 3 different types of storage items:
