...
FRAME's [`Storage pallet`](https://substrate.dev/rustdocs/latest/frame_support/storage) gives runtime developers access to Substrate's flexible storage APIs, which can support any value that is encodable
...
- Visit the reference docs for
  ...
  [StorageDoubleMap](https://substrate.dev/rustdocs/latest/frame_support/storage/trait.StorageDoubleMap.html)
