...
We can access events emitted from the `frame_system` pallet using the [`events()` method](https://paritytech.github.io/substrate/master/frame_system/pallet/struct.Pallet.html#method.events):
