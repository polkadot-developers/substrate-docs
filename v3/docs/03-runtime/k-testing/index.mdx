...
The [`sp-io`](https://paritytech.github.io/substrate/master/sp_io/index.html) crate exposes a
[`TestExternalities`](https://paritytech.github.io/substrate/master/sp_io/type.TestExternalities.html)
...
[`substrate_state_machine`](https://paritytech.github.io/substrate/master/sp_state_machine/index.html) referred to as
...
Custom implementations of [Externalities](https://paritytech.github.io/substrate/master/sp_externalities/index.html) allow developers
to construct runtime environments that provide access to features of the outer node. Another example
of this can be found in [`offchain`](https://paritytech.github.io/substrate/master/sp_core/offchain/index.html), which maintains its own
[Externalities](https://paritytech.github.io/substrate/master/sp_core/offchain/trait.Externalities.html) implementation.
...
[in the rustdocs](https://paritytech.github.io/substrate/master/pallet_balances/pallet/struct.GenesisConfig.html), it is defined
as:
...
We can access events emitted from the `frame_system` pallet using the [`events()` method](https://docs.substrate.iohttps://paritytech.github.io/substrate/master/frame_system/pallet/struct.Pallet.html#method.events):
