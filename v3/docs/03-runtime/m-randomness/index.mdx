---
title: Randomness
slug: /docs/v3/runtime/randomness
version: 3.0 
section: docs
category: runtime
keywords:
...
[Randomness Collective Flip Pallet](/rustdocs/latest/pallet_randomness_collective_flip).
...
The second implementation is the [BABE pallet](/rustdocs/latest/pallet_babe),
