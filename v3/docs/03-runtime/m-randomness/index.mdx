---
title: Randomness
slug: /v3/docs/runtime/randomness
---
...
[Randomness Collective Flip Pallet](https://substrate.dev/rustdocs/latest/pallet_randomness_collective_flip).
...
The second implementation is the [BABE pallet](https://substrate.dev/rustdocs/latest/pallet_babe),
