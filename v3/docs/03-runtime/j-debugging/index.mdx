...
## FRAME debugging and logging utilities

The FRAME Support
[`debug` module](/rustdocs/latest/frame_support/debug/index.html) contains
...
[`frame_support::debug::native` module](/rustdocs/latest/frame_support/debug/native/index.html).
...
The
[`frame_support::debug::native::debug!`](/rustdocs/latest/frame_support/debug/native/macro.debug.html)
