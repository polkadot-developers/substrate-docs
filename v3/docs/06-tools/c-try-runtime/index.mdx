...
<img alt="Storage externalities" src="../../../../src/images/docs/advanced/try-runtime-ext-1.png" />

### Testing with externalities

<img alt="Testing with externalities" src="../../../../src/images/docs/advanced/try-runtime-ext-2.png" />
