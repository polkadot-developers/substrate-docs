...
a generic [key-value store](/v3/advanced/storage) where data is [SCALE encoded](/v3/advanced/scale-codec).
...
| :------------------------------------------------: | :------------------------------------------------: |
| ![image](/img/docs/advanced/try-runtime-ext-1.png) | ![image](/img/docs/advanced/try-runtime-ext-2.png) |
...
- [Integrate `try-runtime`][integrate-try-runtime-htg] how-to guide
- [Storage keys](/v3/advanced/storage#storage-value-keys)
