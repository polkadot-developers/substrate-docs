...
1. Use the [how-to-guide template](https://github.com/substrate-developer-hub/substrate-docs/tree/main/v3/docs/00-style-and-contributor-guidelines/how-to-template.md) to organize the information for your topic.
...
* Structure. You’ve followed the [how-to guide template](https://github.com/substrate-developer-hub/substrate-docs/tree/main/v3/docs/00-style-and-contributor-guidelines/how-to-template.md) structure and the conventions described in the [contributor guidelines].
