...
You can download a copy of the Markdown template directly from [here](https://github.com/substrate-developer-hub/substrate-docs/tree/main/v3/docs/00-style-and-contributor-guidelines/how-to-template.md).
