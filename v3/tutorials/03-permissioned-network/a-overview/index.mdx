...
- You are conceptually familiar with
  [P2P Networking](https://wiki.polkadot.network/docs/en/maintain-guides-how-to-setup-sentry-node#p2p-networking) in Substrate. \* We suggest to complete the [Private Network Tutorial](../private-network)
