...
slug: /tutorials/v3/permissioned-network/node-authorization-pallet
version: 3.0 
section: tutorials
...
[offchain worker](/docs/v3/concepts/off-chain-features#off-chain-workers)
...
<Message
  ...
  text=
	...
	[these helpful tips](/docs/v3/getting-started/installation#2-rust-developer-environment).
	"
/>
...
for demonstration: [Alice and Bob](/docs/v3/toolchains/subkey#well-known-keys).
...
We can use [subkey](/docs/v3/toolchains/subkey#generating-node-keys) to generate
...
<Message
  ...
  text=
	...
	Refer to the [install Instructions](/docs/v3/toolchains/subkey#installation).
  	"
/>
