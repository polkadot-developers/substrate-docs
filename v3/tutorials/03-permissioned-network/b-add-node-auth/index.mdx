...
### 2. Add the `node-authorization` pallet
...
### 3. Add genesis storage for our pallet
...
## Next steps
1. Use well-known node keys and Peer IDs to launch your permissioned network
2. Allow access to other nodes to join the network