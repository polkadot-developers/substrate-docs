...
<Message
  ...
  text={[
    ...
    <a href="https://whisperd.tech/bs58-codec/">this one </a>,
...
<Message
  ...
  text={[
    ...
    '`Verification Error: Execution(ApiError("Could not convert parameter \'tx\' between node and runtime`. More details ',
    <a href="https://polkadot.js.org/docs/api/FAQ#the-node-returns-a-could-not-convert-error-on-send">here</a>,
    '.',
  ]}
/>
