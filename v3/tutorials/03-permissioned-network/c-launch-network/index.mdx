...
slug: /v3/tutorials/permissioned-network/launch
version: 3.0 
section: tutorials
...
## Steps
### 1. Obtaining Node Keys and PeerIDs
...
### 2. Alice and Bob Start the Network
...
### 4. Add Dave as a Sub-Node to Charlie
...
## Next steps 
### Learn more 
- Complete the [Private Network Tutorial](../start-a-private-network/index)
- Read more about the [Subkey tool](/v3/docs/toolchains/subkey)
