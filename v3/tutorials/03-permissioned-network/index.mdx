...
- Learn how to use the [node-authorization pallet](https://paritytech.github.io/substrate/master/pallet_node_authorization/pallet/index.html) in your runtime
...
(these are
[associated in a map](https://paritytech.github.io/substrate/master/pallet_node_authorization/pallet/type.Owners.html)
...
More details of this `Config` can be found in the pallet's [reference docs](https://paritytech.github.io/substrate/master/pallet_node_authorization/pallet/trait.Config.html).
...
[reference doc](https://paritytech.github.io/substrate/master/pallet_node_authorization/pallet/enum.Call.html).
...
[mDNS](https://paritytech.github.io/substrate/master/sc_network/index.html) discovery mechanism is enabled
