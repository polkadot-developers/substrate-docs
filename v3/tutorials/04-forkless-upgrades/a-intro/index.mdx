...
slug: /v3/tutorials/forkless-upgrades
hideNav: true
version: 3.0 
section: tutorials
...
[runtime](../../../v3/docs/concepts/runtime) defines the [state](../../../v3/docs/runtime/storage) the
...
without a [hard fork](../../../v3/docs/getting-started/glossary#fork). Because the definition of the
runtime is itself an element in a Substrate chain's state, network participants may update this
value by way of an [extrinsic](../../../v3/docs/concepts/extrinsics), specifically
...
mechanisms for forkless upgrades of [FRAME](../../../v3/docs/runtime/frame)-based runtimes.
First, the
[`sudo_unchecked_weight`](/rustdocs/latest/pallet_sudo/enum.Call.html#variant.sudo_unchecked_weight)
function from the [Sudo pallet](../../../v3/docs/runtime/frame#sudo) will be used to perform an
upgrade that adds the [Scheduler pallet](../../../v3/docs/runtime/frame#scheduler). Then, the
...
[existential (minimum) balance](../../../v3/docs/getting-started/glossary#existential-deposit)
...
<Message
  ...
  1. To get a sense of what runtime upgrades are more concretely, read the
   [runtime upgrade documentation](/v3/docs/runtime/upgrades) first, or at least have
  ...
  2. If you haven't already, you should complete these tutorials before this one:
      ...
      - [Add a Pallet to Your Runtime](/v3/tutorials/add-a-pallet), which will introduce the
...
<TutorialObjective
  data={{
    ...
    url: '/v3/tutorials/forkless-upgrades/sudo-upgrade',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/v3/tutorials/forkless-upgrades/schedule-an-upgrade',
  }}
/>
