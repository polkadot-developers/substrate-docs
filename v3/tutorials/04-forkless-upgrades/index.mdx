...
without a [hard fork](/v3/reference/glossary#fork). Because the definition of the
...
[existential (minimum) balance](/v3/reference/glossary#existential-deposit)
...
pallet's [dispatchable functions](/v3/reference/glossary#dispatch). The Sudo
...
- `authoring_version`: The authorship version for
  [block authors](/v3/reference/glossary#author).
...
- `transaction_version`: The version of the
  [dispatchable function](/v3/reference/glossary#dispatch) interface.
...
[`ExistentialDeposit`](/v3/reference/glossary#existential-deposit) - the
