...
slug: /v3/tutorials/forkless-upgrades/schedule-an-upgrade
version: 3.0 
section: tutorials
...
the only [extrinsic](/v3/docs/concepts/extrinsics) in a block.

### 1. Prepare an Upgraded Runtime
...
[`ExistentialDeposit`](/v3/docs/getting-started/glossary#existential-deposit) - the
...
<Message
  ...
  text=
	  ...
	  [storage migration](/v3/docs/runtime/upgrades#storage-migrations), which is out of
	  scope for this tutorial.
	  "
/>

### 2. Build the Upgraded Runtime
...
- Learn about [storage migrations](/v3/docs/runtime/upgrades#storage-migrations) and
