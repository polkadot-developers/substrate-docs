...
slug: /tutorials/v3/forkless-upgrades/schedule-an-upgrade
version: 3.0 
section: tutorials
...
the only [extrinsic](/docs/v3/concepts/extrinsics) in a block.
...
[`ExistentialDeposit`](/docs/v3/getting-started/glossary#existential-deposit) - the
...
<Message
  ...
  text=
	  ...
	  [storage migration](/docs/v3/runtime/upgrades#storage-migrations), which is out of
...
- Learn about [storage migrations](/docs/v3/runtime/upgrades#storage-migrations) and
