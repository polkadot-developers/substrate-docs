...
- [A minimalist tutorial on writing your runtime pallet in its own package](/tutorials/v3/proof-of-existence/).
- With your node now capable of running smart contracts, go learn about
  [Substrate ink! smart contracts](/v3/smart-contracts/overview).
- [Substrate Recipes](https://substrate.dev/recipes/) offers detailed tutorials about writing
  ...
  this tutorial.
- Understand the [Chain Spec](/v3/toolchains/chain-specs) file to customize your Genesis
  Configuration.
