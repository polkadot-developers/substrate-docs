...
## Learning outcomes
- Understand the implementation requirements for the Contracts pallet
- Implement a custom runtime API for the contracts pallet
- Adding an RPC API extension
...
FRAME [`pallet_contracts::Config` documentation](https://substrate.dev/rustdocs/latest/pallet_contracts/trait.Config.html).
