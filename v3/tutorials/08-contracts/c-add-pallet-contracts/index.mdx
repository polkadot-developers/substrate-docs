...
slug: /v3/tutorials/add-contracts/pt2
version: 3.0 
section: tutorials
category: contracts
...
- [A minimalist tutorial on writing your runtime pallet in its own package](/v3/tutorials/proof-of-existence/pallet).
...
- [Substrate Recipes](https://substrate.dev/recipes/) offers detailed tutorials about writing
  ...
  this tutorial.
- Understand the [Chain Spec](/v3/docs/toolchains/chain-specs) file to customize your Genesis
  Configuration.
