...
If you would like a basic dashboard to start [here is a template example](../../../../src/images/tutorials/06-visualize-node-metrics/Substrate-Node-Template-Metrics.json) that you can `Import` in Grafana to get basic information about your node:
