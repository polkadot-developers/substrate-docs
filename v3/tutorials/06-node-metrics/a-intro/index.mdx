...
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/node-metrics/p1#install-prometheus-and-grafana',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/node-metrics/p1#configure-prometheus-to-scrape-your-substrate-node',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/node-metrics/p1#visualizing-prometheus-metrics-with-grafana',
  }}
/>
