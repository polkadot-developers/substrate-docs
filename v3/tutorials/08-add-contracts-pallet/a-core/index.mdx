...
slug: /v3/tutorials/add-contracts-pallet
---
...
[Create Your First Substrate Chain Tutorial](/v3/tutorials/create-your-first-substrate-chain).
...
[demonstration Substrate node runtime](https://github.com/paritytech/substrate/tree/latest/bin/node/runtime)
...
- With your node now capable of running smart contracts, go learn about
  [Substrate ink! smart contracts](/v3/docs/smart-contracts/overview).
- [Substrate Recipes](https://substrate.dev/recipes/) offers detailed tutorials about writing
  ...
  this tutorial.
- Understand the [Chain Spec](/v3/docs/toolchains/chain-spec) file to customize your Genesis
  Configuration.

### References

- [FRAME `Contracts` Pallet API](https://substrate.dev/rustdocs/latest/pallet_contracts)
