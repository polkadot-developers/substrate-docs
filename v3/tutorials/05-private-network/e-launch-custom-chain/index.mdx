...
slug: /v3/tutorials/private-network/launch-custom-chain
version: 3.0 
section: tutorials
...
## Steps
### 1. First Participant Starts a Bootnode
...
are necessary for
[block _production_](/v3/docs/getting-started/glossary#author);
GRANDPA keys are necessary for
[block _finalization_](/v3/docs/getting-started/glossary#finality).
...
[**Aura**](/v3/docs/getting-started/glossary#aura-aka-authority-round)
key. You can repeat those steps to insert your
[**GRANDPA**](/v3/docs/getting-started/glossary#grandpa) key (the
**ed25519** key)
...
### 3. Verify Keys in the Keystore (Optional)
...
### 4. Subsequent Participants Join
...
Learn more about how the [executor](/v3/docs/advanced/executor) uses on-chain Wasm.
