...
slug: /tutorials/v3/private-network/launch-custom-chain
version: 3.0 
section: tutorials
...
are necessary for
[block _production_](/docs/v3/getting-started/glossary#author);
GRANDPA keys are necessary for
[block _finalization_](/docs/v3/getting-started/glossary#finality).
...
[**Aura**](/docs/v3/getting-started/glossary#aura-aka-authority-round)
key. You can repeat those steps to insert your
[**GRANDPA**](/docs/v3/getting-started/glossary#grandpa) key (the
**ed25519** key)
...
Learn more about how the [executor](/docs/v3/advanced/executor) uses on-chain Wasm.
