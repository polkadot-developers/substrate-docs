...
slug: /v3/tutorials/private-network/custom-chainspec
version: 3.0 
section: tutorials
...
<Message
  type={`green`}
  title={`Tip`}
  text={`Further details about all of these commands are available by running:
...
by the **"grandpa"** field. That section looks like this using the [two provided demo](/v3/tutorials/private-network/key-generation#option-3-use-pre-generated-keys) keys:
