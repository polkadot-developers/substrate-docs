...
slug: /tutorials/v3/private-network/key-generation
version: 3.0 
section: tutorials
...
Begin by compiling and installing the utility (<a target="_blank" href="/docs/v3/toolchains/subkey">instructions and more info here</a>). This may take up to 15 minutes or so.
