...
slug: /v3/tutorials/private-network/key-generation
version: 3.0 
section: tutorials
...
Begin by compiling and installing the utility (<a target="_blank" href="../../../v3/docs/toolchains/subkey">instructions and more info here</a>). This may take up to 15 minutes or so.
...
## Next steps 
1. Create a custom chain specification using your key pairs
2. Share your custom chain specicification with your network validators