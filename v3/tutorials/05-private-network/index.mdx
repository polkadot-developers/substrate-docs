...
<TutorialObjective
  data={{
    textLineOne: '1. Alice and Bob Start Blockchain',
    url: '/tutorials/v3/private-network#alice-and-bob-start-blockchain',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: '2. Generate ed25519 and sr25519 key-pairs for use as a network authority.',
    url: '#generate-your-own-keys',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: '3. Create and edit a chainspec JSON file.',
...
<Message
  type={`green`}
  title={`Tip`}
  text="Some Ad blockers (e.g. the built-in Shield in Brave browser, pihole, browser extentions, etc.)
