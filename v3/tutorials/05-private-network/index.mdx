...
<TutorialObjective
  data={{
    textLineOne:
      ...
      url: '/tutorials/v3/private-network/alice-and-bob',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/private-network/key-generation',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/private-network/custom-chainspec',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/private-network/launch-custom-chain',
  }}
/>
...
This example used [pair 1](../key-generation#pair-1) from the well known seeds here, and
will use [pair 2](../key-generation#pair-2) for our next node, where your keys may differ.
