...
are necessary for
[block _production_](/v3/reference/glossary#author);
GRANDPA keys are necessary for
[block _finalization_](/v3/reference/glossary#finality).
...
[**Aura**](/v3/reference/glossary#aura-aka-authority-round)
key. You can repeat those steps to insert your
[**GRANDPA**](/v3/reference/glossary#grandpa) key (the
**ed25519** key)
