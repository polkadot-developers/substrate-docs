...
slug: /v3/tutorials/create-your-first-substrate-chain/background
version: 3.0 
section: tutorials
...
- [Storage](/v3/docs/advanced/storage)
- [Peer-to-peer networking](https://libp2p.io)
- [Consensus capabilities](/v3/docs/advanced/consensus)
- [Extrinsic handling](/v3/docs/concepts/extrinsics) (more than just transactions)
- A [Runtime](/v3/docs/concepts/runtime))
- and [more...](/v3/docs/getting-started/overview)
...
## Next Steps 
1. Run your compiled node template  
2. Start your front-end template