...
slug: /tutorials/v3/create-your-first-substrate-chain/background
version: 3.0 
section: tutorials
...
- [Storage](/docs/v3/advanced/storage)
- [Peer-to-peer networking](https://libp2p.io)
- [Consensus capabilities](/docs/v3/advanced/consensus)
- [Extrinsic handling](/docs/v3/concepts/extrinsics) (more than just transactions)
- A [Runtime](/docs/v3/concepts/runtime))
- and [more...](/docs/v3/getting-started/overview)
