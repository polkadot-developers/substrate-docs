...
slug: /tutorials/v3/create-your-first-substrate-chain/interact
version: 3.0 
section: tutorials
...
- `--dev` this sets up a developer node [chain specification](/docs/v3/toolchains/chain-specs)
...
### 3. Interact with your node

Once the Front-End Template is running and loaded in your browser at `localhost:8000`, take a
moment to explore its components. At the
...
[the well-known test accounts](/docs/v3/toolchains/subkey#well-known-keys) that you have
...
[the metadata that your runtime exposes](/docs/v3/runtime/metadata).
...
[Extrinsics](/docs/v3/concepts/extrinsics) are the runtime's callable functions;
...
[unsigned](/docs/v3/concepts/extrinsics#unsigned-transactions) or
[signed](/docs/v3/concepts/extrinsics#signed-transactions) extrinsics and also
...
[the values present in your runtime's storage](/docs/v3/runtime/storage). The RPC and
Constant options provide additional mechanisms for runtime interaction.

Like many blockchains, Substrate chains use [events](/docs/v3/runtime/events) to report
...
If you've experienced any issues with this tutorial or want to provide feedback, you can
