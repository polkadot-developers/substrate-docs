...
- `--dev` this sets up a developer node [chain specification](/v3/toolchains/chain-specs)
...
[the well-known test accounts](/v3/toolchains/subkey#well-known-keys) that you have
...
[the metadata that your runtime exposes](/v3/runtime/metadata).
...
[Extrinsics](/v3/concepts/extrinsics) are the runtime's callable functions;
...
[unsigned](/v3/concepts/extrinsics#unsigned-transactions) or
[signed](/v3/concepts/extrinsics#signed-transactions) extrinsics and also
...
[the values present in your runtime's storage](/v3/runtime/storage). The RPC and
Constant options provide additional mechanisms for runtime interaction.

Like many blockchains, Substrate chains use [events](/v3/runtime/events) to report
