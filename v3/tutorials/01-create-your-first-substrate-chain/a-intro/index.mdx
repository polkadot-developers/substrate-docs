...
slug: /v3/tutorials/create-your-first-substrate-chain
hideNav: true
version: 3.0 
section: tutorials
...
<TutorialObjective
  data={{
    ...
    url: '/v3/tutorials/create-your-first-substrate-chain/setup',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/v3/tutorials/create-your-first-substrate-chain/background',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/v3/tutorials/create-your-first-substrate-chain/interact',
  }}
/>

## Learning outcomes
- Learn how to install and use Substrate's node template 
- Learn how to interact with a live Substrate node using Polkadot JS Apps  

<AccentButton text={`Sounds good? Let's begin!`} link={`/v3/tutorials/create-your-first-substrate-chain/setup`} />
