...
<Message
  ...
  text={['Complete the ',
 <a href="../../../v3/docs/getting-started/installation">official Installation guide</a>,
 '. After `rustup` has been installed and configured, and you\'ve configured the Rust toolchain to default to the latest stable version you can return to these steps.',
  ]}
/>
...
<Message
  ...
  'Refer to the ', 
  <a href="../../../v3/docs/getting-started/installation#troubleshooting-substrate-builds">troubleshooting tips page </a>,
