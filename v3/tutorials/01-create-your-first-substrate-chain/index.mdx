...
<center>
  <img
    src="../../../src/images/tutorials/01-create-your-first-chain/forks.png"
    alt="Blockchain Forks"
    width="50%"
  />
</center>
<br />
...
<TutorialObjective
  data={{
    textLineOne: '1. Set up a Substrate development environment on your computer.',
...
- Ask a question on <ExternalLink url="https://stackoverflow.com/questions/tagged/substrate">Stack Overflow</ExternalLink> using the substrate tag.
