...
blockchain. The Node Template includes [a number of components](/docs/v3/getting-started/architecture), including
a [runtime](/docs/v3/getting-started/glossary#runtime) that is constructed using
[FRAME](/docs/v3/runtime/frame) runtime development framework. However, in order to
...
=======
      '1. Add the Nicks pallet to your Node Template',
    url: '/tutorials/v3/add-a-pallet/import',
>>>>>>> bae3605cbd30fb97cd46cef2363c0906c53e4994
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/add-a-pallet/configure',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/add-a-pallet/interact',
  }}
/>
<TutorialObjective
  data={{
    ...
    url: '/tutorials/v3/add-a-pallet/publish',
  }}
/>
...
<<<<<<< HEAD
<AccentButton text={`Ready? Let's get right to it!`} link={`/v3/tutorials/add-a-pallet/import`}/>
=======
