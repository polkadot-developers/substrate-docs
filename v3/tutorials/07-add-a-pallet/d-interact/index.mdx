...
slug: /tutorials/v3/add-a-pallet/interact
version: 3.0 
section: tutorials
...
<Message
  ...
  text=
    ...
    [front-end setup instructions](/tutorials/v3/create-your-first-substrate-chain/setup#install-the-front-end-template)
...
[interact with a pallet](/tutorials/v3/create-your-first-substrate-chain/interact#pallet-interactor-&-events).
...
[runtime storage](/docs/v3/runtime/storage) of the Nicks pallet.
...
[fees](/docs/v3/runtime/weights-and-fees) for the dispatch, but there weren't any state changes
executed because the Nicks pallet follows the important
[verify-first-write-last](/docs/v3/runtime/storage#verify-first-write-last) pattern. Now
...
- Learn how to add a more complex pallet to the Node Template by going through the
  [Add the Contracts Pallet](/how-to-guides/v3/pallet-design/contracts-pallet) guide.
  
  - Complete the [Forkless Upgrade a Chain](/tutorials/v3/forkless-upgrades) tutorial to learn how Substrate enables
