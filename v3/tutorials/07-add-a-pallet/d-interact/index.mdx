...
slug: /v3/tutorials/add-a-pallet/interact
version: 3.0 
section: tutorials
...
[Create Your First Chain](/v3/tutorials/create-your-first-substrate-chain) and [Build a dApp](/v3/tutorials/proof-of-existence)
...
<Message
  ...
  text=
    ...
    [front-end setup instructions](/v3/tutorials/create-your-first-substrate-chain/setup#install-the-front-end-template)
...
### 3. Use the Nicks Pallet

You should already be familiar with using the Front-End Template to
[interact with a pallet](/v3/tutorials/create-your-first-substrate-chain/interact#pallet-interactor-&-events).
...
[runtime storage](/v3/docs/runtime/storage) of the Nicks pallet.
...
[fees](/v3/docs/runtime/weights-and-fees) for the dispatch, but there weren't any state changes
executed because the Nicks pallet follows the important
[verify-first-write-last](/v3/docs/runtime/storage#verify-first-write-last) pattern. Now
...
- Learn how to add a more complex pallet to the Node Template by going through the
  [Add the Contracts Pallet](/v3/how-to-guides/pallet-design/contracts-pallet) guide.
  
- Complete the [Forkless Upgrade a Chain](/v3/tutorials/forkless-upgrades) tutorial to learn how Substrate enables
