...
correctly. You can also view the [full solution of including the `Nick` pallet](https://github.com/substrate-developer-hub/substrate-node-template/tree/tut-sols/add-a-pallet%2Flatest).
