...
<TutorialObjective
  data={{
    textLineOne: '1. Add the Nicks pallet to your Node Template',
    url: '/tutorials/v3/add-a-pallet#import-the-nicks-pallet',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: '2. Implement the Nicks pallet configuration trait.',
...
<Message
  type={`gray`}
  title={`Note`}
  text="Not all pallets will expose all of these runtime types, and some may expose more! You
...
- <ExternalLink url="https://doc.rust-lang.org/stable/cargo/">
    The Cargo book
  </ExternalLink>
- <ExternalLink url="https://rustwasm.github.io/">
