...
documentation](/rustdocs/latest/pallet_nicks/pallet/trait.Config.html) or the
definition of the trait itself in [the source code](https://github.com/paritytech/substrate/blob/master/frame/nicks/src/lib.rs)
of the Nicks pallet.
...
1. Select the [`setName` dispatchable](/rustdocs/latest/pallet_nicks/pallet/enum.Call.html#variant.set_name) as
...
1. Copy and paste the address for the alice account in the Account field, then click **Query**.
   ...
   ![Read an empty name](name-of-bob.png)

## Explore more advanced topics

This tutorial
Use the `Signed` button to invoke
[the `killName` dispatchable](/rustdocs/latest/pallet_nicks/pallet/enum.Call.html#variant.kill_name)
...
![`BadOrigin` Error](kill-name-bad-origin.png)
...
![Nicks Pallet Error](clear-name-error.png)
...
Sudo pallet's
[`sudo` function](/rustdocs/latest/pallet_sudo/pallet/enum.Call.html#variant.sudo) is
