...
![image](../../../../src/images/tutorials/11-kitties-workshop/kitties-tutorial.png)
...
Make sure you have configured your environment for Substrate development by installing [Rust and the Rust toolchain](/v3/getting-started/dev-env).
...
[installation]: /v3/getting-started/dev-env
...
[dispatchable-kb]: /v3/reference/glossary#dispatch
