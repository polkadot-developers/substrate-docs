...
This improves code readability and re-usability too.
...
1. Making use of [`try_mutate`](https://paritytech.github.io/substrate/master/frame_support/storage/trait.StorageMap.html#tymethod.try_mutate) to update the kitty's owner vector.
...
3. Using [`put`](https://paritytech.github.io/substrate/master/frame_support/storage/trait.StorageValue.html#tymethod.put) provided by the StorageValue API to store the latest Kitty count.
...
Notice the use of [`#[transactional]`](https://paritytech.github.io/substrate/master/frame_support/attr.transactional.html) which we imported at the very beginning of this tutorial.
...
Remember we're using a [`BoundedVec`](https://paritytech.github.io/substrate/master/frame_support/storage/bounded_vec/struct.BoundedVec.html) that can only hold a fixed number of Kitties, defined in our pallet's `MaxKittyOwned` constant.
...
[currency-frame-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/traits/tokens/currency/index.html
[currency-balances-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/traits/tokens/currency/trait.Currency.html#associatedtype.Balance
[balances-frame]: https://paritytech.github.io/substrate/master/pallet_balances/index.html
[currency-transfer-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/traits/tokens/currency/trait.Currency.html#tymethod.transfer
...
[storagevalue-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/storage/trait.StorageValue.html
[storage-api-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/storage/index.html
...
[randomness-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/traits/trait.Randomness.html
[hash-rustdocs]: https://paritytech.github.io/substrate/master/sp_runtime/traits/trait.Hash.html
[blake2-rustdocs]: https://paritytech.github.io/substrate/master/sp_core/hashing/fn.blake2_128.html
[randomness-collective-flip-frame]: https://paritytech.github.io/substrate/master/pallet_randomness_collective_flip/index.html
[nonce-rustdocs]: https://paritytech.github.io/substrate/master/frame_system/struct.AccountInfo.html#structfield.nonce
[2x64-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/struct.Twox64Concat.html
[prelude-traits-rustdocs]: https://paritytech.github.io/substrate/master/sp_std/prelude/index.html#traits
...
[currency-frame]: https://paritytech.github.io/substrate/master/frame_support/traits/tokens/currency/trait.Currency.html#associatedtype.Balance
[frame-macros-kb]: /v3/runtime/macros#palletcall
[txn-fees-kb]: /v3/runtime/weights-and-fees
[weights-kb]: /v3/concepts/weight
[contains-key-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/storage/trait.StorageMap.html#tymethod.contains_key
[insert-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/storage/trait.StorageMap.html#tymethod.insert
[storage-value-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/storage/types/struct.StorageValue.html#method.put
[storagemap-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/storage/types/struct.StorageMap.html#method.insert
[events-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/attr.pallet.html#event-palletevent-optional
[events-kb]: /v3/runtime/events-and-errors
[polkadotjsapps]: https://polkadot.js.org/apps/#/explorer
[dispatchresult-rustdocs]: https://paritytech.github.io/substrate/master/frame_support/dispatch/type.DispatchResult.html
