...
In a separate terminal, start an instance of `node-kitties` that you built in Part I (or use the [Kitty nodesolution](https://github.com/substrate-developer-hub/substrate-node-template/tree/tutorials/kitties) instead if you haven't completed part I):
