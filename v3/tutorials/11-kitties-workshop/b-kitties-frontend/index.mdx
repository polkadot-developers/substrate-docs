...
<Message
  ...
  title="Note"
  text={`
    If you haven't completed [Part I](/tutorials/v3/kitties/pt2) and just want to focus on building the Kitties front-end, clone the Kitty node solution from [this branch](https://github.com/substrate-developer-hub/substrate-node-template/tree/tutorials/solutions/kitties) and use that to follow this part of the tutorial.
  `}
/>
...
In a separate terminal, start an instance of `node-kitties` that you built in Part I (or use the [Kitty node solution](https://github.com/substrate-developer-hub/substrate-node-template/tree/tutorials/solutions/kitties) instead if you haven't completed part I):
...
We have setup the ground work of accessing the chain and saving all Kitty information internally using React.
...
1. As a preliminary step, create a new file called `KittyCards.js` and add the following imports:
   ...
   - It also contains a "transfer" and "cancel" button.
     ...
     ![kitty-transfer-shot.png](../../../../src/images/tutorials/11-kitties-workshop/kitty-transfer-shot.png)
