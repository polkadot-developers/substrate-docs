...
<ExternalLink url="https://github.com/paritytech/polkadot-launch">polkadot-launch</ExternalLink> is a
Node utility script that does this for you, allowing for some custom configurations to setup networks
very simply.
