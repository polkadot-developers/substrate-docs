...
slug: /v3/tutorials/cumulus-workshop/relay-spec
version: 3.0 
section: tutorials
category: parachains
keywords:
...
You will need a chain specification ([chain spec](/v3/docs/toolchains/chain-specs))
...
[well-known development accounts](/v3/docs/toolchains/subkey#well-known-keys).
...
>
> - The [`subkey` tool](/v3/docs/toolchains/subkey) (v2.0.1 and above for BEEFY keys)
...
<Message
  type={`green`}
  title={`SS58 Encoding of Key vs. Address`}
  text={`In the case of sr25519 and ed25519, the account ID matches its public key, hence SS58 encoded
