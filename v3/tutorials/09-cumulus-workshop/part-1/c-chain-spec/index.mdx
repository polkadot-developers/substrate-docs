...
You will need a chain specification ([chain spec](/docs/v3/toolchains/chain-specs))
...
[well-known development accounts](/docs/v3/toolchains/subkey#well-known-keys).
...
>
> - The [`subkey` tool](/docs/v3/toolchains/subkey) (v2.0.1 and above for BEEFY keys)
