...
slug: /v3/tutorials/cumulus-workshop/para-node-template
version: 3.0 
section: tutorials
category: parachains
keywords:
...
traits, the `pallet-template` itself is essentially identical. Many of the [Substrate devhub tutorials](/v3/tutorials/)
