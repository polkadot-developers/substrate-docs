...
- <ExternalLink url="https://wiki.polkadot.network/docs/build-pdk">Parachain Development Overview</ExternalLink>
...
- <a href="/assets/tutorials/cumulus-workshop/chainspecs/rococo-custom-3-raw.json">
  ...
  Plain chain spec <a href="/assets/tutorials/cumulus-workshop/chainspecs/rococo-custom-3-plain.json">
    included
  </a>
  .
...
- <a href="/assets/tutorials/cumulus-workshop/chainspecs/rococo-custom-4-raw.json">
  ...
  and fourth validators. Plain chain spec <a href="/assets/tutorials/cumulus-workshop/chainspecs/rococo-custom-4-plain.json">
    included
  </a>
  .
