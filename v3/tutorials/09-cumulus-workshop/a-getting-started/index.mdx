...
- **Polkadot** tagged [**`v0\.9\.10`**](https://github.com/paritytech/polkadot/tree/v0.9.10)
...
<ExternalLink url="https://github.com/paritytech/polkadot/releases">
  latest release of Polkadot.
</ExternalLink>
Please check with us in the
<ExternalLink url="https://matrix.to/#/#parachain-technical:matrix.parity.io">
  Parachain Technical matrix channel
</ExternalLink>
...
<ExternalLink url="https://github.com/substrate-developer-hub/substrate-parachain-template">
  {' '}
  Parachain Template{' '}
</ExternalLink>
(similar but not identical to the
<ExternalLink url="https://github.com/substrate-developer-hub/substrate-node-template">
  {' '}
  Node Template{' '}
</ExternalLink>
) to launch our first parachain and make cross-chain asset transfers. Later, we will use it as the starting
point for developing our own parachains. In a different terminal window:
...
- <a href="/assets/tutorials/cumulus-workshop/chainspecs/rococo-custom-4-raw.json" download>
  ...
  and fourth validators. (<a href="/assets/tutorials/cumulus-workshop/chainspecs/rococo-custom-4-plain.json">
    plain chain spec
  </a>
  ).
