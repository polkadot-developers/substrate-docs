...
using Cumulus. To learn more about parachains before continuing this workshop, 
...
<TutorialObjective
  data={{
    textLineOne:
      '3. Relay Chain Chain Specification',
    url: '#relay-chain-chain-specification',
  }}
/>
<TutorialObjective
  data={{
...
<!-- TODO: ## Acknowledgement & Contribution Refer to [Acknowledgement & Contribution](acknowledgement-contribution) -->
...
## Relay Chain Chain Specification

You will need a chain specification ([chain spec](/v3/toolchains/chain-specs))
for your relay chain network. You can use one that is [included with this workshop](/0-files/chainspecs/rococo-custom-2-plain.json), or create your own.
...
- [rococo-custom-2-raw.json](v3/tutorials/09-cumulus-workshop/z-FILES/chainspecs/rococo-custom-2-raw.json)
  : A two-validator relay chain with Alice and Bob as authorities. Useful for registering
  a single parachain. Plain chain spec: [rococo-custom-2-plain.json](v3/tutorials/09-cumulus-workshop/z-FILES/chainspecs/rococo-custom-2-plain.json)
...
[well-known development accounts](/v3/toolchains/subkey#well-known-keys).
...
>
> - The [`subkey` tool](/v3/toolchains/subkey) (v2.0.1 and above for BEEFY keys)
...
[Substrate private network tutorial](/tutorials/v3/private-network/launch-custom-chain#add-keys-to-keystore)
