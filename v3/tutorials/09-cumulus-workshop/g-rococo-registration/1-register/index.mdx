...
slug: /v3/tutorials/cumulus-workshop/rococo
version: 3.0 
section: tutorials
category: parachains
keywords:
...
<Message
  type={`yellow`}
  title={`Important`}
  text={`As parachain is being developed in a fast pace, you need to use the
...
- [Reserve a unique Para ID](en/2-relay-chain/2-reserve). This will be assigned to the next
  ...
  <ExternalLink url={`https://wiki.polkadot.network/docs/learn-common-goods#system-level-chains`}>system parachains </ExternalLink>
  and `1000-1999` are reserved for <ExternalLink url={`https://wiki.polkadot.network/docs/learn-common-goods#public-utility-chains`}>public utility parachains</ExternalLink>
