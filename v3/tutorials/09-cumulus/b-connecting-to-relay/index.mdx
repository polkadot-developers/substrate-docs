...
connect a parachian with any previous state to a relay chain. All parachains must start from block 0
...
> This is 10 blocks for the example [`rococo-custom-2-raw.json`](/assets/tutorials/cumulus/chainspecs/rococo-custom-2-raw.json)
...
parachian data is lost, you will **not** be able to recover the chain!
  `}
/>
