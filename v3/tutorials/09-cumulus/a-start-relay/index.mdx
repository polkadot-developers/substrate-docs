...
- [Polkadot `v0.9.22`](https://github.com/paritytech/polkadot/tree/release-v0.9.22)
- [Substrate Parachain Template `polkadot-v0.9.22`](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.22)
...
[**Polkadot \`v0.9.22\`**](https://github.com/paritytechtree/release-), use the equivalent
version of [**Parachain Template \`polkadot-v0.9.22\`**](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.22).
`}
/>
