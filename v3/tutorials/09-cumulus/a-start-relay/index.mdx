...
- [Polkadot `v0.9.20`](https://github.com/paritytech/polkadot/tree/release-v0.9.20)
- [Substrate Parachain Template `polkadot-v0.9.20`](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.20)
- [Polkadot-JS Apps `v0.113.2-45 `](https://github.com/polkadot-js/apps/commit/df915e38afacf94b0a8297850c5c92a35d06af52).
...
[**Polkadot \`v0.9.20\`**](https://github.com/paritytechtree/release-), use the equivalent
version of [**Parachain Template \`polkadot-v0.9.20\`**](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.20).
`}
/>
...
**After you start the compilation, it will take a while (15 to 60 minutes) to complete.**
...
> Again, this will take 15 to 60 minutes to complete.
