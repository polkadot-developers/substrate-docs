...
- [Polkadot `v0.9.13`](https://github.com/paritytech/polkadot/tree/v0.9.13)
- [Substrate Parachain Template `polkadot-v0.9.13`](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.13)
- [Polkadot-JS Apps `v0.98.2-121`](https://github.com/polkadot-js/apps/commit/03d53ce1551bc0cd55c55491fa20e652d7eaa4c6).
  It is generally expected that the [hosted Polkadot-JS Apps](https://polkadot.js.org/apps) should work.
...
<Message
  ...
  text={`
    ...
    [**Polkadot \`v0.9.13\`**](https://github.com/paritytech/polkadot/tree/v0.9.13), use the equivalent
    version of [**Parachain Template \`polkadot-v0.9.13\`**](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.13).
  `}
/>
...
<Message
  ...
  text={`
    If you intend to let others connect to your network, you should have the genesis Wasm and the associated chain spec for your network generated once and distributed to your peers.
...
Jump to the [conversion](#convert-plain-to-raw-chain-spec) section to see how to do that.

> The above raw chain specs were created according to the steps in the [create your own chain spec](#create-a-custom-relay-chain-spec-optional) section.
...
Optionally, explore the [how-to guide on configuring a custom chain spec](/how-to-guides/v3/basics/custom-chainspec) for instructions to tweak the provided [plain chain spec](/assets/tutorials/cumulus/chain-specs/rococo-custom-2-plain.json) for addition of more validators without modification of Polkadot's source code.
