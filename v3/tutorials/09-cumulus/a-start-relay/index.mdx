...
<TutorialObjective
  data={{
    textLineOne: 'Hardware and software requirements',
    url: '#hardware-and-software-requirements',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: 'Build your nodes',
    url: '#build-your-nodes',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: 'Parachain node template overview',
    url: '#parachain-node-template-overview',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: 'Relay chain specification',
    url: '#relay-chain-specification',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: 'Start your relay chain ',
    url: '#start-your-relay-chain',
  }}
/>
<TutorialObjective
  data={{
    textLineOne: 'Create a custom relay chain spec (optional)',
...
**no less than**:
\n
- 8 GB of RAM (16 GB are suggested)
...
connecting to. To have the least hiccups, be sure to use the corresponding tagged
...
- A two-validator relay chain with Alice and Bob as authorities. Useful for registering a single
  parachain - [plain chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-2-plain.json),
  [raw chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-2-raw.json).

- A three-validator relay chain identical to `rococo-custom-2-raw` spec, with Charlie as the third
  validator - [plain chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-3-plain.json),
  [raw chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-3-raw.json).
...
- A four-validator relay chain identical to `rococo-custom-2-raw` spec, with Charlie and Dave as
  ...
  [plain chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-4-plain.json),
  [raw chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-4-raw.json).
...
[two-validator raw chain spec](/assets/tutorials/cumulus/chainspecs/rococo-custom-2-raw.json)
