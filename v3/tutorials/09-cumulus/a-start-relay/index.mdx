...
- [Polkadot `v0.9.23`](https://github.com/paritytech/polkadot/tree/release-v0.9.23)
- [Substrate Parachain Template `polkadot-v0.9.23`](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.23)
- [Polkadot-JS Apps `v0.115.3-49`](https://github.com/polkadot-js/apps/commit/18d95a4a61cdd31ec64b034ce07fafa46dd87258).
...
[**Polkadot \`v0.9.23\`**](https://github.com/paritytechtree/release-), use the equivalent
version of [**Parachain Template \`polkadot-v0.9.23\`**](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.23).
`}
/>
