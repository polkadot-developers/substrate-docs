...
- [Polkadot `v0.9.19`](https://github.com/paritytech/polkadot/tree/release-v0.9.19)
- [Substrate Parachain Template `polkadot-v0.9.19`](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.19)
- [Polkadot-JS Apps `v0.112.2-37`](https://github.com/polkadot-js/apps/commit/b24e7b131805d1c1fb23e8ebdeeb46ff200bc2f5).
...
[**Polkadot \`v0.9.19\`**](https://github.com/paritytechtree/release-), use the equivalent
version of [**Parachain Template \`polkadot-v0.9.19\`**](https://github.com/substrate-developer-hub/substrate-parachain-template/tree/polkadot-v0.9.19).
`}
/>
