...
- [Reserve a unique para ID](connect-parachain#1-reserve-a-para-id). This will be assigned to the next available ID.
...
- Your parachain genesis state.
  Refer to the [genesis state export process](connect-parachain#3-generate-parachain-genesis-state).

- Your parachain Wasm runtime.
  Refer to the [Wasm runtime export process](connect-parachain#4-obtain-wasm-runtime-validation-function).
