...
slug: /v3/tutorials/proof-of-existence/front-end
version: 3.0 
section: tutorials
...
Complete the [Add a Pallet](/v3/tutorials/add-a-pallet/) tutorial to learn how to extend the Node Template with
additional capabilities from Substrate's set of
[core FRAME pallets](/v3/docs/runtime/frame).
