...
1. Replace all contents of `pallets/template/src/lib.rs` with the following skeleton code that includes a few minimal [macros for FRAME V2](https://paritytech.github.io/substrate/master/frame_support/attr.pallet.html):
