...
At this point you have a completed pallet! Now to _use_ the pallet, we must correctly configure it in your runtime. 
...
One very typical hash type used in many web3 applications is a [CID](https://github.com/multiformats/cid), and the V1 instance of these is uniformly `60 bytes` in length.
So here we specify hashes will be of this length or less in the runtime:
