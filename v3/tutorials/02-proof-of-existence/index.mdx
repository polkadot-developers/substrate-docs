...
1. Replace all contents of `pallets/template/src/lib.rs` with the following skeleton code that includes all of the [***mandatory*** macros for FRAME V2](https://docs.substrate.io/rustdocs/latest/frame_support/attr.pallet.html):
