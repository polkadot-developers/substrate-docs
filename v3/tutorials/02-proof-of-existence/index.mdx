...
1. Replace all contents of `pallets/template/src/lib.rs` with the following skeleton code that includes all of the [**_mandatory_** macros for FRAME V2](https://docs.substrate.io/rustdocs/latest/frame_support/attr.pallet.html):
   ...
   pub mod pallet {
   	...
   	#[pallet::config]  // TODO: Replace me!

   	#[pallet::event]   // TODO: Replace me!

   	#[pallet::error]   // TODO: Replace me!

   	#[pallet::storage] // TODO: Replace me!

   	#[pallet::call]    // TODO: Replace me!
   }
   ```

   You now have a scaffold that includes placeholders for _events_, _errors_, _storage_, and _callable functions_.

1. Save your changes, but don't build yet.
...
To define the `Config` trait for the proof-of-existence pallet, open the `pallets/template/src/lib.rs` file in a text editor and replace the `#[pallet::config]` line with the following code block:
...
To implement the pallet events, replace the `#[pallet::event]` line with the following code block:
...
To implement the errors for the proof-of-existence pallet, replace the `#[pallet::error]` line with the following code block:
...
To implement storage for the proof-of-existence pallet, replace the `#[pallet::storage]` line with the following code block:
...
To implement this logic in the proof-of-existence pallet, replace the `#[pallet::call]` line with the following code block:
