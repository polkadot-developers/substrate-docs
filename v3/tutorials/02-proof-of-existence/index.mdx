...
<AccentButton text={`Sounds good? Let's begin!`} link={`#prepare-to-build-a-dapp`} />
...
![Runtime Composition](../../../../src/images/docs/runtime/frame-runtime.png)
...
<Message
  type={`yellow`}
  title={`Information`}
  text={`Have a look at [the skeleton of a FRAME pallet](/v3/runtime/pallets#frame-v2)
...
### 5. Implement a `StorageMap` storage item
...
### 1. Explore the Front-End Template
...
### 2. Add your custom react component
