...
slug: /v3/tutorials/proof-of-existence/prepare
version: 3.0 
section: tutorials
...
[Create Your First Substrate Chain Tutorial](/v3/tutorials/create-your-first-substrate-chain). If you do not,
...
<Message
  ...
  [Create Your First Chain Tutorial](/v3/tutorials/create-your-first-substrate-chain/setup#install-the-front-end-template)
  if necessary.
  "
/>
