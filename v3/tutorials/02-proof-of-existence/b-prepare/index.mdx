...
<Message
  ...
  text={[
      ...
      <a href="https://github.com/substrate-developer-hub/substrate-node-template#getting-started">the instructions in its readme </a>,
      '.',
  ]}
/>
...
<Message
  ...
  <a href="../create-your-first-substrate-chain/setup#install-the-front-end-template">Create Your First Chain Tutorial </a>,
  'if necessary.',
  ]}
/>
