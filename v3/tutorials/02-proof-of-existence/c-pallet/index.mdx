...
slug: /v3/tutorials/proof-of-existence/pallet
version: 3.0 
section: tutorials
...
has a FRAME-based [runtime](/v3/docs/concepts/runtime).
[FRAME](/v3/docs/runtime/frame) is a library of code that allows
...
<Message
  type={`yellow`}
  title={`Information`}
  text={`Have a look at [the skeleton of a FRAME pallet](/docs/en/knowledgebase/runtime/pallets#frame-v2) 
...
By doing this, we've declared the dependencies and [macros](/v3/docs/runtime/macros) our pallet will require to function.
...
<Message
  ...
  text=
    ...
    tutorial. Learn more about [testing in Substrate here](/v3/docs/runtime/testing).
    "
/>
