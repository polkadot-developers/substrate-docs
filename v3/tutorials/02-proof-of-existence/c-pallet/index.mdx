...
<Message
  ...
  text={[
      ...
      '_runtime_ module that _must_ compile to WASM, and therefore cannot depend on rust\'s `std` dependencies.',
...
<Message
  ...
  text={[
      ...
      <a href="https://github.com/substrate-developer-hub/substrate-node-template/tree/tutorials/solutions/build-a-dapp-v3+1"> here </a>,
