...
slug: /tutorials/v3/proof-of-existence/pallet
version: 3.0 
section: tutorials
...
has a FRAME-based [runtime](/docs/v3/concepts/runtime).
[FRAME](/docs/v3/runtime/frame) is a library of code that allows
...
<Message
  type={`yellow`}
  title={`Information`}
  text={`Have a look at [the skeleton of a FRAME pallet](/docs/v3/runtime/pallets#frame-v2)
...
By doing this, we've declared the dependencies and [macros](/docs/v3/runtime/macros) our pallet will require to function.
...
<Message
  ...
  text=
    ...
    tutorial. Learn more about [testing in Substrate here](/docs/v3/runtime/testing).
    "
/>
