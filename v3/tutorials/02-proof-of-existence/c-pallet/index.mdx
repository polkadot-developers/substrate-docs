...
Have a look at [the skeleton of a FRAME pallet](/v3/docs/runtime/pallets#frame-v2) from the knowledgebase to learn more about the basic structure of a FRAME pallet.
