...
1. **With the Substrate Node**: You can run the pre-designed [Substrate Node](https://github.com/paritytech/substrate/tree/master/bin/node) and
...
3. **With Substrate Core**: The entire FRAME system can be ignored, and the runtime can be designed and implemented from
   ...
   Substrate, but also gives you the most freedom to innqovate.
...
![Technical Freedom vs Development Ease](../../../src/images/technical-freedom.png)
