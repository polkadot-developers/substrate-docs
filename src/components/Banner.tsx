...
const Banner = () => {
  ...
  return (
    <div
      className={cx(
        'hidden md:block fixed z-50 right-10 bottom-8 w-1/3 p-6 transition-all text-white dark:text-black dark:bg-substrateGray bg-substrateGray-darkest m-0 shadow-xxl rounded-md',
        {
    ...
    >
      ...
      <p className="mb-0 leading-6 mdx-anchor">
		...
		<b><Link to="https://area51.stackexchange.com/proposals/126136/substrate-blockchain-framework">
			StackExchange	
        </Link></b>{' '}
		forum!	
		<br></br>
		<b>Please help us by following and upvoting questions to a score of 10{' '}
