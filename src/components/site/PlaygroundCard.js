      ...
      <div className="group relative">
        ...
        <div
          className={cx(
            ...
            {
              'ring-4 ring-substrateGreen border-transparent': props.preSelected,
            }
          )}
        >
          <div className="flex items-center mb-10">
            ...
            <div className="text-2xl md:text-3xl ml-5 font-extrabold">{props.title}</div>
          </div>
          <div className="font-bold text-lg mb-6 lg:h-[140px] xl:h-full">{props.description}</div>
