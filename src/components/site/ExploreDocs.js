      ...
      items: [
        {
          ...
          description: 'Explore the basics of Substrate’s FRAME and start creating your custom pallets.',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Understand how benchmarking and weights are used to calculate transaction fees. ',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: 'Publish libraries that can create offline transactions specific to your chain.',
        },
      ],
    },
  ];
