...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className="hidden lg:inline-block lg:flex-none lg:h-auto lg:bg-substrateGray-light lg:dark:bg-substrateDark border-r border-gray-200 dark:border-gray-700">
      <div
        className={cx('sticky top-16 mb-12', {
      ...
      >
        <div className="pt-4 relative">
          <button
            ...
            className="absolute right-4 mt-2.5 mr-0.5 bg-substrateDark dark:bg-white p-2 rounded-lg transform transition-opacity duration-300 ease-in-out hover:opacity-80 focus:outline-none z-10"
          >
            <Icon
              name="sidebar-toggle"
          ...
          <div
            className={cx('w-64 px-4 z-0 transition-all transform ', {
