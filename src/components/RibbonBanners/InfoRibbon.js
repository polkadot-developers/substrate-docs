...
export default function InfoRibbon({ link }) {
  return (
    <div
      className="flex flex-row bg-blue-100 border-l border-r border-t border-b border-blue-500 w-100 min-h-[4rem] text-blue-700 px-4 py-3 items-center content-center"
      role="alert"
    >
      <div className="flex-1 sm:flex-initial">
        <svg
          className="fill-current lg:w-5 lg:h-5 md:w-5 md:h-5 h-8 w-8 mr-2"
