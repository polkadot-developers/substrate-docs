...
import flagIcon from '../images/version-flag.svg'
  ...
  return (
    <div className="flex items-center justify-end">
      ...
      >
        ...
        <div className="pl-1 text-substrateBlue underline">{`Version ${version}`}</div>
        {isComponentVisible && (
      ...
      <div className="hidden lg:block lg:pl-2">
        <a
          className="text-sm text-black hover:underline lg:flex lg:items-center "
          href="#"
          target="_blank"
          rel="norefferror"
        >
