...
export function DarkButton({ text, link }: DarkButtonProps) {
  return (
    <>
      <LocalizedLink className="inline-block my-6" to={link}>
        <div className="flex items-center justify-center w-80 h-16 rounded-lg bg-black dark:bg-gray-800 hover:no-underline">
          <button className="text-lg text-white font-bold pr-4 focus:outline-none hover:no-underline">
            {text}
          </button>
          <svg
