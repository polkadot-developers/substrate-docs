...
export function PreviousButton({ text, link }: PreviousButtonProps) {
  ...
  return (
    <>
      <LocalizedLink className="md-button group inline-block" to={link}>
        <div className="flex items-center justify-start w-80 h-14">
          <svg
            className="fill-current text-black dark:text-white mr-4 ml-4 transform transition-all duration-300 ease-in-out group-hover:ml-2 group-hover:mr-6"
            width="16"
            height="12"
            viewBox="0 0 16 12"
          ...
          <button className="truncate text-lg text-black dark:text-white font-bold focus:outline-none border-b-2 border-substrateDark ">
