  ...
  return (
    <>
      <LocalizedLink className="inline-block  m-2 hover:no-underline" to={link}>
        <div className="flex items-center justify-center px-8 h-16">
          <svg
            className="fill-current text-black dark:text-white mr-4"
            width="16"
            height="12"
            viewBox="0 0 16 12"
          ...
          <button className="text-lg text-black dark:text-white font-bold focus:outline-none border-b-2 border-substrateDark ">
