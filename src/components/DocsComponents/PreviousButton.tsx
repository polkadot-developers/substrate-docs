  ...
  return (
    <>
      <LocalizedLink className="inline-block  m-2" to={link}>
        <div className="flex items-center justify-center px-8 h-16 rounded border-2 border-black dark:border-white">
          <svg
          ...
          <button className="text-lg text-black dark:text-white font-bold pl-4 focus:outline-none">
