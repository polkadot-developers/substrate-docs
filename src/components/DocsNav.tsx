    ...
    >
      <div>
        ...
        >
          ...
          <div>
            <hr className="mt-6" />
            <div className="flex items-center justify-between px-20 lg:px-4 py-4 bg-lightGray lg:bg-white lg:dark:bg-black">
            ...
            {globalNav
              ...
              .map((navItem, index) => {
                return (
                  <div
                    key={index}
                    className="px-20 lg:px-4 py-4 bg-lightGray lg:bg-white lg:dark:bg-black"
                  >
                    {navItem.external ? (
                      <a
