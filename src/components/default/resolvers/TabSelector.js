...
export const TabSelector = ({ isActive, children, onClick }) => (
  <button
    className={`lg:mr-8 md:mr-6 sm:mr-3 xs:mr-1 group inline-flex items-center px-2 py-4 border-b-2 font-medium text-sm leading-5 cursor-pointer whitespace-nowrap ${
      isActive
